...
describe("favouriteBlog", () => {
  ...
  test("given a list of multiple blogs, it returns the blog with the most likes", () => {
  ...
  test("given an empty list, it returns null", () => {
...
describe("mostBlogs", () => {
  ...
  test("given a list of multiple blogs, it returns the author with the largest amount of blogs", () => {
...
describe("mostLikes", () => {
  ...
  test("given a list of multiple blogs, it returns the author with the most likes", () => {
